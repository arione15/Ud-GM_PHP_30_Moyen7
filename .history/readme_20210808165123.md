...
2. Pour faire la liaison entre `Player` et `Arme` : dans la class Arme, définir un tableau `static $armes`, contenant toutes les armes instanciées, afin de pouvoir y accèder de partout
```php
class Arme{
